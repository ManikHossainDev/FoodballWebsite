      ...
      <div className="py-8 grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-3 rounded-xl flex flex-col gap-4">
          <div className="bg-[#3F3F3F] p-2 md:p-5 rounded-lg">
            ...
            {/* FIX: added mt-3 gap between heading and list */}
      ...
      {isOpen && (
        ...
        >
          <div className="bg-[#1E1E1E] rounded-xl w-full max-w-md mx-4 overflow-hidden shadow-2xl">
            ...
            {/* Footer — FIX: corrected button labels */}
            <div className="px-6 pb-5 flex items-center justify-end gap-3">
              <button
                onClick={() => setIsOpen(false)}
                className="text-gray-400 text-sm px-4 py-2 rounded-lg hover:text-white hover:bg-[#2A2A2A] transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={handleSubmit}
                className="bg-[#E43636] text-white text-sm font-medium px-5 py-2 rounded-lg hover:bg-red-700 transition-colors"
              >
                Submit
              </button>
            </div>
