          ...
          >
            ...
            <div className="p-4 pb-3">
              ...
              <div className="flex items-center  text-yellow-500 mb-2">
                ...
                <span className="text-gray-400 text-xs">(37 reviews)</span>
              </div>
              {/* Experience */}
              <p className="text-gray-400 text-xs pl-1">Experience {player.experience}</p>
            </div>
            ...
            <div className="space-y-2 px-2 pb-3">
              ...
              <Link className="block w-full" href={`/messages/${player.id}`}>
