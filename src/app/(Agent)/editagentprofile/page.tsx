...
const Page = () => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      location: profile.profile?.location?.toString() ?? "",
      // Read from serviceName or title seamlessly
      serviceName:
        profile.profile?.service?.serviceName ??
        profile.profile?.service?.title ?? "",
  ...
  const isserviceNameValid = formData.serviceName.trim().length > 0;
  ...
  const handleSave = async () => {
    ...
    if (!isserviceNameValid) {
      Swal.fire({
        ...
        text: "Please enter a Service Title before saving.",
        icon: "warning",
      });
    ...
    const payload = {
      ...
      profile: {
        ...
        service: {
          // Send explicitly as serviceName to satisfy Mongoose schema requirements
        ...
        <div className="w-full ">
          ...
          <div className="bg-[#303030] rounded-2xl p-6 flex items-center justify-between mb-2 ">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={handleSave}
                disabled={isSaving || !isserviceNameValid}
                title={
                  !isserviceNameValid
                    ? "Enter a Service Title before saving"
                    : undefined
                }
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className={`w-full bg-[#525252] border text-gray-300 px-4 py-3 rounded text-sm focus:outline-none ${
                          !isserviceNameValid
                            ? "border-red-500 focus:border-red-500"
                            : "border-[#FFFFFF] focus:border-gray-600"
                        }`}
                      />
                      {!isserviceNameValid && (
